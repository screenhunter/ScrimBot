module.exports = {
  ...
  // i.e: "-scrimbot foo" will trigger the command "foo",
  //      whereas "ScrimBot foo" will do nothing at all.
  prefix:  "!sb",

  // Your bot's user token. If you don't know what that is, go here:
  // https://discordapp.com/developers/applications/me
  // Then create a new application and grab your token.
  token: "MjY3NDA4NjQ1MjUwMjIwMDMy.C1LzRQ.wRIKtZhPOnHxJXAKcp3RZApKXjQ",
